...
pub struct ClaimToken<'info> {
    ...
    pub buyer_presale_token_associated_token_account: Box<Account<'info, TokenAccount>>,
    ...
    pub presale_presale_token_associated_token_account: Box<Account<'info, TokenAccount>>,
